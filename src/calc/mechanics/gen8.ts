...
function calculateGen8(
  ...
  console.log(`baseDamege1: ${baseDamage}`);
  console.log(`level: ${attacker.level}`);
  ...
  console.log(`baseDamege: ${baseDamage}`);
  console.log(`typeEffectiveness: ${typeEffectiveness}`);
  console.log(`stabMod: ${stabMod}`);
